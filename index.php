...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="Quiz test.html" class="title">Quiz Time!!!</a>
            <p>Start The Quiz</p>
            <div class="info">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="newprog.php" class="title">Download pdf</a>
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="meet.html" class="title">lets chat!!!</a>
            <p>Join the zoom classroom</p>
            <div class="info">
                <h3> <i class="far fa-clock"></i> 2 hours </h3>
                <h3> <i class="far fa-calendar-alt"></i> 6 months </h3>
                <h3> <i class="fas fa-book"></i> 12 modules </h3>
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="board.html" class="title">White Board</a>
            <p>Make the learning</p>
            <div class="info">
                <h3> <i class="far fa-clock"></i> 2 hours </h3>
                <h3> <i class="far fa-calendar-alt"></i> 6 months </h3>
                <h3> <i class="fas fa-book"></i> 12 modules </h3>
