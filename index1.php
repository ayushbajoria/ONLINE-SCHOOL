...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="index.php" class="title">JAVA CLASS</a>
            <p>Join java Class</p>
            <div class="info">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="index.php" class="title">MACHINE LEARNING</a>
            <p>Let's go for Machine Learning!!!</p>
            <div class="info">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="index.php" class="title">Web development</a>
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="index.php" class="title">DATA STRUCTURES AND ALGORITHMS</a>
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <a href="#" class="title">DISCRETE MATHEMATICS</a>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem, beatae. Modi quos excepturi id quibusdam? Molestiae quis nihil non debitis!</p>
            <div class="info">
                <h3> <i class="far fa-clock"></i> 2 hours </h3>
                <h3> <i class="far fa-calendar-alt"></i> 6 months </h3>
